...
#define VF610_NFC_IO_PAD_CTRL (PAD_CTL_SPEED_HIGH | PAD_CTL_SRE | \
				PAD_CTL_DSE_50ohm | PAD_CTL_PUS_47K_UP | PAD_CTL_OBE_IBE_ENABLE)
#define VF610_NFC_SIG_PAD_CTRL	(PAD_CTL_SPEED_HIGH | PAD_CTL_SRE | \
				PAD_CTL_DSE_50ohm | PAD_CTL_PUS_47K_UP | PAD_CTL_OBE_ENABLE)
#define VF610_NFC_SIG_RB_PAD_CTRL	(PAD_CTL_SPEED_HIGH | PAD_CTL_SRE | \
...
enum {
	...
	VF610_PAD_PTD31__NFC_IO15		= IOMUX_PAD(0x00fc, 0x00fc, 2, __NA_, 0, VF610_NFC_IO_PAD_CTRL),
	VF610_PAD_PTD30__NFC_IO14		= IOMUX_PAD(0x0100, 0x0100, 2, __NA_, 0, VF610_NFC_IO_PAD_CTRL),
	VF610_PAD_PTD29__NFC_IO13		= IOMUX_PAD(0x0104, 0x0104, 2, __NA_, 0, VF610_NFC_IO_PAD_CTRL),
	VF610_PAD_PTD28__NFC_IO12		= IOMUX_PAD(0x0108, 0x0108, 2, __NA_, 0, VF610_NFC_IO_PAD_CTRL),
	VF610_PAD_PTD27__NFC_IO11		= IOMUX_PAD(0x010c, 0x010c, 2, __NA_, 0, VF610_NFC_IO_PAD_CTRL),
	VF610_PAD_PTD26__NFC_IO10		= IOMUX_PAD(0x0110, 0x0110, 2, __NA_, 0, VF610_NFC_IO_PAD_CTRL),
	VF610_PAD_PTD25__NFC_IO9		= IOMUX_PAD(0x0114, 0x0114, 2, __NA_, 0, VF610_NFC_IO_PAD_CTRL),
	VF610_PAD_PTD24__NFC_IO8		= IOMUX_PAD(0x0118, 0x0118, 2, __NA_, 0, VF610_NFC_IO_PAD_CTRL),
	VF610_PAD_PTD23__NFC_IO7		= IOMUX_PAD(0x011c, 0x011c, 2, __NA_, 0, VF610_NFC_IO_PAD_CTRL),
	VF610_PAD_PTD22__NFC_IO6		= IOMUX_PAD(0x0120, 0x0120, 2, __NA_, 0, VF610_NFC_IO_PAD_CTRL),
	VF610_PAD_PTD21__NFC_IO5		= IOMUX_PAD(0x0124, 0x0124, 2, __NA_, 0, VF610_NFC_IO_PAD_CTRL),
	VF610_PAD_PTD20__NFC_IO4		= IOMUX_PAD(0x0128, 0x0128, 2, __NA_, 0, VF610_NFC_IO_PAD_CTRL),
	VF610_PAD_PTD19__NFC_IO3		= IOMUX_PAD(0x012c, 0x012c, 2, __NA_, 0, VF610_NFC_IO_PAD_CTRL),
	VF610_PAD_PTD18__NFC_IO2		= IOMUX_PAD(0x0130, 0x0130, 2, __NA_, 0, VF610_NFC_IO_PAD_CTRL),
	VF610_PAD_PTD17__NFC_IO1		= IOMUX_PAD(0x0134, 0x0134, 2, __NA_, 0, VF610_NFC_IO_PAD_CTRL),
	VF610_PAD_PTD16__NFC_IO0		= IOMUX_PAD(0x0138, 0x0138, 2, __NA_, 0, VF610_NFC_IO_PAD_CTRL),
	VF610_PAD_PTB24__NFC_WEB		= IOMUX_PAD(0x0178, 0x0178, 5, __NA_, 0, VF610_NFC_SIG_PAD_CTRL),
	VF610_PAD_PTB25__NFC_CE0B		= IOMUX_PAD(0x017c, 0x017c, 5, __NA_, 0, VF610_NFC_SIG_PAD_CTRL),
	VF610_PAD_PTB27__NFC_REB		= IOMUX_PAD(0x0184, 0x0184, 6, __NA_, 0, VF610_NFC_SIG_PAD_CTRL),
	VF610_PAD_PTC26__NFC_RBB		= IOMUX_PAD(0x018c, 0x018c, 5, __NA_, 0, VF610_NFC_SIG_RB_PAD_CTRL),
	VF610_PAD_PTC27__NFC_ALE		= IOMUX_PAD(0x0190, 0x0190, 6, __NA_, 0, VF610_NFC_SIG_PAD_CTRL),
	VF610_PAD_PTC28__NFC_CLE		= IOMUX_PAD(0x0194, 0x0194, 6, __NA_, 0, VF610_NFC_SIG_PAD_CTRL),
VF610_PAD_PTA7__GPIO_134            = IOMUX_PAD(0x0218, 0x0218, 0, __NA_, 0, NO_PAD_CTRL),
